from Helper import * #these type of imports cant be within a function(importing *)
import copy
...
from isSquareChecked import isKingInCheck #these types can be within a function(importing specific functions)
